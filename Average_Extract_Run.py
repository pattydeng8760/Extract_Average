...
nstart = 7       # solution dir count to begin the extract
nend = -1       # solution dir count to end the extract (-1 for all)
...
ave_dirName = '/project/rrg-moreaust-ac/denggua1/Bombardier_LES/B_10AOA_U50/RUN_Fine/AVE/'
